  ...
  var crawler = new Crawler({
    ...
    callback: function(err, resp, done) {
      ...
      if(productLink) {
        ...
        var price = parseInt($('#span-price').text().replace('₫', '').replace(/\./g, ''));
        // console.log(price);
        var discount = $('#span-saving-price').clone().children().remove().end().text().replace('₫', '');
        // console.log(discount);
        var originPrice = parseInt($('#span-list-price').text().replace('₫', '').replace(/\./g, ''));
